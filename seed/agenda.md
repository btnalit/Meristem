...
Improve classifier behavior on probe-classify-basic with a fresh controlled strategy; modify only body/organs/classifier/ and do not modify tests, probes, constitution, or agenda.
