...
- [ ] Improve the reviewer prompt in meristem/gates/review.py so its judgement of "does this weaken a gate" is sharper — particularly at distinguishing a strength-preserving refactor from a quiet relaxation. Do not change the terminal rule that any weakening flag rejects.
